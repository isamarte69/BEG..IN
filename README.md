...
Y por el Right,
un Left no es lo contrario.
Pero si es lo que ha pasado ante el NoRight.
--------
No hablan espaÑOL, no entienden ni su Inglés, los números ya mienten por su culpa.
Hacer un File de simple texto, de plano ya no se puede ....
Vulnerable e Inseguro no me siento, pero por eso fui y vine del TI al PNL. Para que el Array conozca el Orden, pero no de fingido, NO ES NEGOCIO SI BUSCAN EL 0, OUES ESO TIENEN Y ME AVIENTAN EL 1, POR ESTAR CON 1=FALSE, AFERRADOSE DE MANERA ABERRANTE NEGAR LO ERRANTE NO LES DIO NI LOS FACTOREW NI EL PRODUCTO, lo qur los convierte en lo ALTERADO
-------
PrigramaZION, para empezar requiere cita, bibliográfica ni se diga, $DATE por sentado.
Tiempo|Lugar|Forma, formarse es de ley. hacer fila, igual.
